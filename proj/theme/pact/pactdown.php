...
echo '<body style="-webkit-print-color-adjust: exact;">
<div class="container" style="width: 800px; margin:0 auto" id="print">';
	 $ex = explode("|",$info[2]['pact']);
   echo '<small>合同编号：';
   echo $info[2]['number'];
   echo '-';
   echo $info[0]['id'];
   echo '</small></div>';
echo '<h2 style="text-align: center;font-weight: bold;">网络借款协议</h2>
    <div style="margin-top: 30px;">
        ...
        echo '</p>';
        echo '<p>乙方（借款人）:';
        echo $info[3]['company_name'];
        echo '</p>';
        echo '<p>法定代表人:';
        echo $info[3]['legal_person'];
        echo '</p>';
        echo '<p>住所地:';
        echo $info[3]['address'];
        echo '</p>';
        echo '<p>统一社会信用代码：';
        echo $info[3]['license_no'];
        echo '</p>';
        ...
        echo '<p style="margin-bottom:20px;">注册号：';
        echo $ex[1];
        echo '</p>';
		
        echo '<p>丁方(平台方): 北京泰恒长隆网络科技有限公司</p>
		<p>法定代表人：葛继华</p>
		<p>住所地：北京市海淀区紫竹院路广源闸5号4层4138</p>
        <p>统一社会信用代码：91110108MA00113G5A </p>
    </div>
    <br>';
	
	echo '<p>快投机器平台是指：北京泰恒长隆网络科技有限公司经营的为其注册用户提供专业网络借贷交易居间服务的互联网平台，网站域名为：www.kuaitoujiqi.com</p>
    ...
    <table border="1" cellspacing="0" cellpadding="0" width="100%" >';
       echo '<tr>
        ...
        echo $info[1]['monkey'];
        echo '元(';
        echo ParseNumber(sprintf("%d", $info[1]['monkey']));
        echo ')</td>
        </tr>';
        echo '<tr>
            <td>年化利率</td>
            <td>';
        echo $info[2]['rate']*100;
        echo '%</td>
        </tr>';
        ...
        echo '<tr>
            <td>本息合计</td>
            <td>';
        echo $info[1]['monkey']-(-interest($info[2]['rate'],$info[2]['day'],$info[1]['monkey']));
        echo '元(';
        echo ParseNumber($info[1]['monkey']-(-interest($info[2]['rate'],$info[2]['day'],$info[1]['monkey'])));
        echo ')</td>';
        echo '</tr>
        <tr>
            <td>还款方式</td>	
        ...
        <tr>
            <td>借贷期限</td>
            <td>自';
        echo date('Y-m-d',$info[2]['starttime']);
        echo  '至';
        echo date('Y-m-d',$info[2]['endtitme']);
        echo '</td>
        </tr>
    </table>
    <br>';
  ...
  echo '<p>甲方（出借人）:';
   ...
   echo '</p>';
    ...
    echo $ex[0];
    echo '</p>';
    echo '<p>丁方(平台方): 北京泰恒长隆网络科技有限公司
    </p>

    <br><br><br>';

    echo '<p style="text-align: right;font-weight: bold">签订日期：';
    echo date('Y年m月d日',$info[2]['starttime']);
    echo '</p>';
    
    echo '<h3>附件:还款计划</h3>';
    echo '<table width="400" border="0" class="table table-striped">
      <tr>
        <td>还款日期</td>
        <td>付息金额</td>
        <td>还本金额</td>
      </tr>';
      for($i=1;$i<=$info[2]['day'];$i++){
      echo '<tr>';
        echo '<td>';
        echo date('Y年m月d日',next_time($info[2]['starttime']-86400,$i-1));
        echo '</td>';
        echo '<td>';
...
header('Content-Disposition: attachment; filename=合同.doc'); 
