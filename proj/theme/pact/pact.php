...
<button type="button" class="btn btn-primary" id="print_btn" style="margin-left: 605px;margin-right: 10px;">打印</button>
 <a href="<?php echo site_url('usercenter/pact/'.$id.'/3');?>"><button type="button" class="btn btn-primary"  >下载</button> </a>
 <span style="margin-left: 10px;">(注：以本页面显示的电子合同为准)</span>
 </div>
</div>
