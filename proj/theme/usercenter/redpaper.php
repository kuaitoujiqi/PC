				...
				<div class="col-md-9 col-xs-12">
					<div class="row user_head">
						...
						<div class="col-md-8 col-xs-12">
							<div class="row" style="line-height:40px;margin-top:10px;padding:0px;">
								<div class="col-md-3 col-xs-12" style="padding:0px;"><div class="col-md-12 col-xs-12 text-right" style="font-size:12px;padding:0px;margin-top:30px;">
									提高您当前的安全等级
								</div></div>
                            ...
                            <table class="table table-striped" style="">
                                ...
                                <!-- <?php var_dump($value);?> -->
                                 <tr>
                                    ...
                                    <td><?php echo date('Y年m月d日',$value['alltime']);?></td>
                                    <td><?php echo $value['allmoney']?></td>
