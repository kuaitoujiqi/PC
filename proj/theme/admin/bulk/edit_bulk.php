...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
     ...
     <tr>
        <td class="tableleft" width="15%">借款用途</td>
        <td><input type="text" name="use" value="<?php echo set_value('use',$row['use']);?>"/><?php echo form_error('use');?></td>
    </tr>
    <tr>
        <td class="tableleft" width="15%">借款手机</td>
        <td><input type="text" name="phone" value="<?php echo set_value('phone',$row['phone']);?>"/><?php echo form_error('phone');?></td>
    </tr>
    <tr>
