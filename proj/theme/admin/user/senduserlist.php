    ...
    <tr>
        ...
        <th>操作</th>
	     ...
	     <tr>
            ...
            <td>
				<a role="btn" pid="<?php echo $key['productid'];?>" uid="<?php echo $key['id'];?>" money="<?php echo $key['monkey'];?>" class="btn btn-danger createRedPacket">生成红包</a>
				<a role="btn" pid="<?php echo $key['productid'];?>" uid="<?php echo $key['id'];?>" money="<?php echo $key['monkey'];?>" class="btn btn-warning sendRedPacket">发送红包</a>
			</td>
        </tr>	
        <?php }?>
</table>
