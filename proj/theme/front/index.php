...
$(function(){
						...
						<div style="margin-top:20px;">
							<?php if($key['static'] == 1){
								...
								<?php }else{
										...
										<?php }else{?>
											<a class="btn btn-normal btn-block" href="<?php echo site_url('product/bulk_standard/'.$key['id']);?>"  style="background-color:#f68121;border:0px;color:#fff;" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;立 即 购 买&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
							<?php } } }?>
							<?php if($key['static'] == 2){?>
	...
	<div class="transfer_listed" style="width:1150px;margin:10px auto;">
		...
		<table class="project_tab" style="width:1120px;margin:0px auto 40px;">
			...
			<?php foreach($transfers as $v=>$key){?>
			<?php if($v <= 2){?>
			<tr>
				<td class="text-left"><a href="<?php echo site_url('product/transfer/'.$key['id']);?>"><?php 
				$length = mb_strlen($key['title']);
				if($length > 20){
				echo mb_substr($key['title'], 0,20, 'utf-8');
				echo "&nbsp",'...';
                }else{
                	echo $key['title'];
                }
		...
		<div class="platform row" style="width:1150px;margin:0px auto 0px;">
			<div class="col-xs-6 col-md-6 FLeft ">
				<table class="col-xs-12 col-md-12 bank_safe" style="padding-left:0px;">
					<?php foreach($webgonggao as $key){?>
					<tr>
						<td><a class="text_in" href="<?php echo site_url('news/article/'.$key['id']);?>"><?php echo mb_substr($key['title'], 0,30, 'utf-8'); echo "&nbsp",'...';?></a></td>
					</tr>
					<?php }?>
				</table>
			...
			<div class="col-xs-6 col-md-6 fRight">
				<table class="col-xs-12 col-md-12 bank_safe" style="padding-left:0px;">
					...
					<tr>
						<td><a href="<?php echo site_url('news/article/'.$key['id']);?>" rel="nofollow"><?php echo $key['title'];?></a></td>
					</tr>
					<?php }?>
				</table>
			</div>					
	...
	<div style="background-color:#fff;padding-bottom:30px;">
		<div style="width:1150px;margin:10px auto;padding-top:20px;">
			...
			<div style="margin:20px 0px 30px 50px;">
				...
				<a href="https://pay.sina.com.cn/zjtg" target="_blank" rel="nofollow"><img src="<?php echo base_url();?>style/img/V2_15.jpg"  /></a>
				<a href="http://www.jhrlawyer.com/" target="_blank" rel="nofollow"><img src="<?php echo base_url();?>style/img/header/V2_17.jpg" /></a>
				<a href="<?php echo site_url('news/article_partener');?>#ly" target="_blank" rel="nofollow"><img src="<?php echo base_url();?>style/img/header/V2_19.jpg" /></a>
				<a href="https://www.aliyun.com/?utm_medium=text&utm_source=bdbrand&utm_campaign=bdbrand&utm_content=se_32492" target="_blank" rel="nofollow"><img src="<?php echo base_url();?>style/img/header//V2_21.jpg"  /></a>
