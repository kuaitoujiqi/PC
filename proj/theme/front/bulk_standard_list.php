				...
				<div style="margin-top:20px;">
					<?php if($key['static'] == 1){
						...
						<?php }else{
							...
							//预告  当前时间小于开始时间?>
								<a href="<?php echo site_url('product/bulk_standard/'.$key['id']);?>" class="btn btn-block btn-normal" id="ljgm_step3" style="background-color:#337ab7;color:#fff;" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;即 将 上 线&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
							<?php }else{?>
					...
					<?php }?>
					<?php if($key['static'] == 3){?>
						<input type="button" class="btn btn-default btn-normal btn-block" id="ljgm_step3" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已 结 束&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" disabled="disabled">
					<?php }?>										
					<?php if($key['static'] == 4){?>
						<input type="button" class="btn btn-default btn-normal btn-block" id="ljgm_step3" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;初 审 中&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" disabled="disabled">
					<?php }?>
				</div>
				<div class="clear"></div>
			</div>
