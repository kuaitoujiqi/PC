	...
	<div class="row text-right m_l register_frame" id="register_frame">
		...
		<form class="form-horizontal col-xs-12 col-md-7">
			...
			<div class="form-group">
				...
				<div class="col-md-5 col-xs-6">
					<input type="password" class="form-control" name="password" id="password" placeholder="8-16位密码">
				</div>
			 ...
			 <div class="form-group">
				...
				<div class="col-md-5 col-xs-6">
					<input type="password" class="form-control" name="matches_password" id="matches_password" placeholder="8-16位密码">
				</div>
