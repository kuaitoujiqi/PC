...
class User extends Admin_Controller {
	...
	function createRedPackets(){
		...
		$packMoney = sprintf("%.2f", floor($money/5000)*12);
	}else{
		$packMoney = sprintf("%.2f", floor($money/5000)*14);
	}
		...
		$order_id = $this->order_m->create_order_redpackets($uid,$packMoney,$remark,$pid);
